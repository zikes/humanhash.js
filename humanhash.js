;(function(global){
    // Word lists taken from the PGP word list located at
    ...
    var evenWords = [
        ...
        'cranky', 'crowfoot', 'crucial', 'crumpled', 'crusade', 'cubic',
        'dashboard', 'deadbolt', 'deckhand', 'dogsled', 'dragnet', 'drainage',
        'dreadful', 'drifter', 'dropper', 'drumbeat', 'drunken', 'Dupont',
        'dwelling', 'eating', 'edict', 'egghead', 'eightball', 'endorse',
        'endow', 'enlist', 'erase', 'escape', 'exceed', 'eyeglass',
        ...
        'miser', 'Mohawk', 'mural', 'music', 'necklace', 'Neptune',
        ...
        'pupil', 'puppy', 'python', 'quadrant', 'quiver', 'quota',
        'ragtime', 'ratchet', 'rebirth', 'reform', 'regain', 'reindeer',
        'rematch', 'repay', 'retouch', 'revenge', 'reward', 'rhythm',
        'ribcage', 'ringbolt', 'robust', 'rocker', 'ruffled', 'sailboat',
        'sawdust', 'scallion', 'scenic', 'scorecard', 'Scotland', 'seabird',
        'select', 'sentence', 'shadow', 'shamrock', 'showgirl', 'skullcap',
        ...
        'tempest', 'tiger', 'tissue', 'tonic', 'topmost', 'tracker',
        'transit', 'trauma', 'treadmill', 'Trojan', 'trouble', 'tumor',
        'tunnel', 'tycoon', 'uncut', 'unearth', 'unwind', 'uproot',
        'upset', 'upshot', 'vapor', 'village', 'virus', 'Vulcan',
        'waffle', 'wallet', 'watchword', 'wayside', 'willow', 'woodlark',
        'Zulu'
    ];
    var oddWords = [
        ...
        'decadence', 'December', 'decimal', 'designing', 'detector', 'detergent',
        'determine', 'dictator', 'dinosaur', 'direction', 'disable', 'disbelief',
        'disruptive', 'distortion', 'document', 'embezzle', 'enchanting', 'enrollment',
        ...
        'Hamilton', 'handiwork', 'hazardous', 'headwaters', 'hemisphere', 'hesitate',
        ...
        'Istanbul', 'Jamaica', 'Jupiter', 'leprosy', 'letterhead', 'liberty',
        'maritime', 'matchmaker', 'maverick', 'Medusa', 'megaton', 'microscope',
        'microwave', 'midsummer', 'millionaire', 'miracle', 'misnomer', 'molasses',
        'molecule', 'Montana', 'monument', 'mosquito', 'narrative', 'nebula',
        'newsletter', 'Norwegian', 'October', 'Ohio', 'onlooker', 'opulent',
        'Orlando', 'outfielder', 'Pacific', 'pandemic', 'Pandora', 'paperweight',
        'paragon', 'paragraph', 'paramount', 'passenger', 'pedigree', 'Pegasus',
        'penetrate', 'perceptive', 'performance', 'pharmacy', 'phonetic', 'photograph',
        ...
        'replica', 'reproduce', 'resistor', 'responsive', 'retraction', 'retrieval',
        ...
        'suspicious', 'sympathy', 'tambourine', 'telephone', 'therapist', 'tobacco',
        'tolerance', 'tomorrow', 'torpedo', 'tradition', 'travesty', 'trombonist',
        'truncated', 'typewriter', 'ultimate', 'undaunted', 'underfoot', 'unicorn',
        'unify', 'universe', 'unravel', 'upcoming', 'vacancy', 'vagabond',
        'vertigo', 'Virginia', 'visitor', 'vocalist', 'voyager', 'warranty',
        'Waterloo', 'whimsical', 'Wichita', 'Wilmington', 'Wyoming', 'yesteryear',
        'Yucatan'
    ];

    HumanHash = {};

    HumanHash.humanize = function(digest, numWords, separator){
        var chars, i, len, hex, output=[];
        ...
        for(i = 0, len = chars.length; i < len && output.length < numWords; i+=2){
            ...
            // use even or odd list depending on current position in array
            output.push((i/2)%2==0 ? evenWords[hex] : oddWords[hex]);
        }

        return output.join(separator);
    };

    global.HumanHash = HumanHash;
